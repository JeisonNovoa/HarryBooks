  ...
  items: [
    {
      ...
      cantidad: Math.floor(Math.random() * 21),
    },
    {
      id: 2,
      ...
      category: "Book",
      description:
        "Harry Potter y los estudiantes de segundo año investigan una malévola amenaza para sus compañeros de clases de Hogwarts, una amenazante bestia que se esconde dentro del castillo.",
      cantidad: Math.floor(Math.random() * 21),
    },
    {
      id: 3,
    ...
    },
    {
      ...
      category: "nike",
      description:
        "El segundo hijo de Harry entró a Hogwarts, pero en Slytherin. Su relación con Harry cada vez es peor y se hizo muy amigo del hijo de Draco, Scorpius Malfoy que se dice que es el hijo de Lord Voldemort",
      cantidad: Math.floor(Math.random() * 21),
    },
  ],
};
